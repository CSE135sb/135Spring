...
<body>
	...
	<%
		return;
				...
				stmt2 = conn.createStatement(
						...
						ResultSet.CONCUR_READ_ONLY);
				rs1 = stmt1
						.executeQuery("SELECT * FROM owners WHERE username = '"
								+ username + "'");
				rs2 = stmt2
						.executeQuery("SELECT * FROM customers WHERE username = '"
								+ username + "'");
	...
	<form action="signup" method="POST">
		<input type="hidden" name="action" value="signupSubmit" /> <label>User
			name: </label> <input name="username" type="text" /> <br> <label>Role:
		</label> <select name="role">
			<option value="owner">Owner</option>
			<option value="customer">Customer</option>
		</select> <br> <label>Age:</label> <input name="age" type="text" /> <br>
