...
<body>
	...
	<table>
		<tr>
			<td><%@ page import="java.sql.*"%> <%@ page
					import="java.util.*"%> <%-- -------- Open Connection Code -------- --%>
				<%
            ...
            %>
					...
					<tr>
						<form action="category" method="POST">
							...
							<%-- Get the c_name --%>
							<td><input value="<%=rs.getString("c_name")%>" name="c_name"
								size="15" /></td>
                ...
                %>
						<form action="category" method="POST">
							<input type="hidden" name="action" value="deleteCategory" /> <input
