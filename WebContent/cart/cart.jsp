...
<body>
	...
	<table border="1">
		...
		<%
			String p_name;
				...
				double totalPrice = 0;
				rs1 = stmt1
						.executeQuery("SELECT * FROM cart_items WHERE owner = '"
		...
		<%
			response.sendRedirect("cart");
					...
					if (!(request.getParameter("cardNumber").isEmpty())) {
						...
						pstmt2 = conn
								.prepareStatement("DELETE FROM cart_items WHERE owner = '"
										+ session.getAttribute("user_id") + "'");
	...
	<form action="cart" method="POST">
		<input type="hidden" name="action" value="cartSubmit" /> <label>Enter
			your credit card number: </label> <input type="text" name="cardNumber" /> <input
			type="submit" name="orderButton" value="Purchase" />
	</form>
</body>
</html>